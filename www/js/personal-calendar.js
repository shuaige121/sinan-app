...
(function (global) {
  ...
  var ZH = {
    'pcal.seal': '个人历',
    'pcal.title': '个人历',
    'pcal.subtitle': '看看哪些日子更贴合你的五行，以及与你出生日发生的关系',
    'pcal.prev_aria': '上个月',
    'pcal.next_aria': '下个月',
    'pcal.weekdays': '一|二|三|四|五|六|日',
    'pcal.month_title': '{year}年{month}月',
    'pcal.legend_favorable': '较贴合你的五行',
    'pcal.legend_unfavorable': '较不贴合你的五行',
    'pcal.legend_neutral': '普通日期',
    'pcal.factor_favorable': '这一天的五行较贴合你',
    'pcal.factor_unfavorable': '这一天的五行较不贴合你',
    'pcal.factor_fuyin': '与出生日是同一组干支（传统称伏吟）',
    'pcal.factor_clash': '与出生日支相冲',
    'pcal.factor_combine': '与出生日支相合',
    ...
    'pcal.ji_top': '黄历避项前三',
    'pcal.none': '无',
    'pcal.source_modern': '按你的五行对照',
    'pcal.source_synthesis': '综合说明',
    'pcal.source_branch': '按出生日日支对照',
    'pcal.source_calendar': '按历法日期对照',
    'pcal.source_fuyin': '与出生当天的日柱对照',
    'pcal.export_day': '导出此日到日历',
    'pcal.export_done': '已导出 {filename}',
    'pcal.export_fail': '暂时没能生成日历文件，请稍后重试',
    'pcal.drawer_aria': '个人历明细',
    'pcal.close_drawer': '关闭个人历明细',
    'pcal.today': '今日',
    'pcal.cache_note': '日期详情已准备好',
  ...
  var EN = {
    ...
    'pcal.source_branch': 'Branch interactions',
    ...
    'pcal.today': 'Today',
    'pcal.cache_note': 'This month is ready',
